...
Updated to match training architecture with Self-Attention
"""
...
def create_initial_frame():
    ...
    cv2.rectangle(img, (12*cell+1, 4*cell+1), (13*cell-2, 5*cell-2), (0, 0, 255), -1)
    return img
...
def main():
    ...
    context = init_tensor.repeat(1, CONTEXT_FRAMES, 1, 1)
    current_action = 0
